...
Cronbach's α. If they are not correlated with each other, then it does
...
2.  Practice: Imagine a study in which the independent variable is
    whether the room where participants are tested is warm (80°) or cool
    (65°). List three dependent variables that you might treat as
...
particular design is a 2 × 2 (read "two-by-two") factorial design
...
then it would be a 3 × 2 factorial design, and there would be six
distinct conditions. Notice that the number of possible conditions is
the product of the numbers of levels. A 2 × 2 factorial design has four
conditions, a 3 × 2 factorial design has six conditions, a 4 × 5
...
psychotherapist (female vs. male). This would be a 2 × 2 × 2 factorial
...
the current example would make it a 2 × 2 × 2 × 3 factorial design with
...
experiments. The top panel shows the results of a 2 × 2 design. Time of
...
panel of Figure \@ref(fig:plots) shows the results of a 4 × 2 design in
...
be conceptualized as a 2 × 2 factorial design with mood (positive vs.
...
responding was −.02, and so on. (Only half the matrix is filled in
...
($X_1, X_2, X_3,…, X_i$), all of which are possible causes of a single
